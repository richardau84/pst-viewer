...
- **Fast search** across all mailboxes: subjects, senders, recipients, body text, and attachment names. Words are typo-tolerant (fuzzy); numbers and reference codes are matched **exactly**, so an ID search stays precise. Matches are highlighted in the open email and it scrolls to the first hit.
